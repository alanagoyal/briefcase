...
export function KeyboardShortcuts({
  ...
  const handleKeyDown = useCallback((e: KeyboardEvent) => {
    ...
    if (e.key === 'ArrowUp' || e.key === 'ArrowDown') {
      e.preventDefault();
      const currentIndex = sortedConversations.findIndex(conv => conv.id === currentConversationId);
      let newIndex;
  ...
  }, [sortedConversations, currentConversationId, onConversationSelect, isSidebarOpen]);
